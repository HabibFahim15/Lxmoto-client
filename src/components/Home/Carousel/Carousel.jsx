...
const Carousel = () => {
  ...
  <div className="absolute top-1/2 left-[50%] lg:left-[600px] transform -translate-x-1/2 -translate-y-1/2 text-center lg:text-left">
    <Fade direction="down">
      <h1 className="lg:text-4xl my-2 text-md font-bold text-white">Best Motorcycles</h1>
    </Fade>
    <Fade direction="down">
      <h1 className="lg:text-6xl my-2 text-xl font-extrabold text-white">Best Motorcycles</h1>
    </Fade>
    <Fade direction="down">
      <p className="text-gray-200 my-2 lg:text-sm text-xs mt-6">Experience the future of technology with Supreme Gadgets. We offer cutting-edge devices and premium accessories designed to enhance your lifestyle. Unleash innovation and elevate your tech game with us today.</p>
    </Fade>
    <Fade direction="up">
    ...
    <Fade direction="up">
      <Link to="#" className="relative inline-flex items-center justify-center lg:justify-start inline-block px-5 py-3 overflow-hidden font-medium transition-all bg-blue-600 rounded-full hover:bg-white group">
        ...
        <SwiperSlide className="relative">
  <img className="lg:h-[700px] h-[500px] w-full opacity-60" src="https://t3.ftcdn.net/jpg/05/34/63/60/360_F_534636028_ZPuCsi4guXQOZYHtqfi8QbH5jAhN5oRg.jpg" alt="Headphone" />
  <div className="absolute top-1/2 left-[50%] lg:left-[600px] transform -translate-x-1/2 -translate-y-1/2 text-center lg:text-left">
    <Fade direction="down">
      <h1 className="lg:text-4xl my-2 text-md font-bold text-white">Best Motorcycles</h1>
    </Fade>
