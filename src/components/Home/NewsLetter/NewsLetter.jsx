  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="flex overflow-hidden rounded-lg bg-gray-100">
      ...
      <div class="relative hidden bg-gray-200 sm:block sm:w-1/3 lg:w-1/2">
        <img src="https://cdn.pixabay.com/photo/2014/07/31/23/10/biker-407123_1280.jpg" loading="lazy" alt="Photo by mymind" class="absolute inset-0 h-full w-full object-cover object-center" />
      </div>
      ...
      <div class="flex w-full items-center p-4 sm:w-2/3 sm:p-8 lg:w-1/2 lg:pl-10">
        <div class="flex w-full flex-col items-center sm:block">
          ...
          <form class="mb-3 flex w-full max-w-md gap-2 sm:mb-5">
            <input placeholder="Email" class="bg-gray-white w-full flex-1 rounded border border-gray-300 px-3 py-2 text-gray-800 bg-white placeholder-gray-400 outline-none ring-indigo-300 transition duration-100 focus:ring" />
